...
public class MainActivity extends Activity
    ...
    public static final String ACTION_SHOW_APP_DETAILS = "com.xh.nativelibsmonitor.SHOW_APP_DETAILS";
    /**
    ...
    AppsModificationsReceiver AppsModReceiver = new AppsModificationsReceiver();
    ...
    private void registerAppsModReceiver() {
        IntentFilter filter = new IntentFilter();
        filter.addAction(Intent.ACTION_PACKAGE_ADDED);
        filter.addAction(Intent.ACTION_PACKAGE_REMOVED);
        filter.addDataScheme("package");

        this.registerReceiver(AppsModReceiver, filter);
    }
    ...
    */
    ...
    protected void onStop() {
        ...
        this.unregisterReceiver(AppsModReceiver);
    }
    */
}
